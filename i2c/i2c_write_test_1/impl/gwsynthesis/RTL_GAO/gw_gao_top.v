...
input \error_cnt[1] ;
input \error_cnt[0] ;
input \u_i2c_send_one_byte/out_done ;
input sys_clk;
input tms_pad_i;
input tck_pad_i;
input tdi_pad_i;
...
wire \error_cnt[1] ;
wire \error_cnt[0] ;
wire \u_i2c_send_one_byte/out_done ;
wire sys_clk;
wire tms_pad_i;
wire tck_pad_i;
wire tdi_pad_i;
