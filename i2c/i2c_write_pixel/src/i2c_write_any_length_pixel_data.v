module i2c_write_any_length_pixel_data(
    input sys_clk,
    input sys_rst_n,
...
parameter CONTROL  = 8'h40;

parameter IDLE             = 6'b00_0001;
parameter START            = 6'b00_0010;
parameter ADDR             = 6'b00_0100;//78
parameter CONTROL_BYTE     = 6'b00_1000;//40
parameter PIXEL_BYTE       = 6'b01_0000;
...
always @(*) begin
    case (cur_state)
        ...
        CONTROL_BYTE:   next_state = (send_done) ? PIXEL_BYTE : CONTROL_BYTE;
        PIXEL_BYTE:     next_state = (pixel_cnt == length) ? STOP : PIXEL_BYTE;
