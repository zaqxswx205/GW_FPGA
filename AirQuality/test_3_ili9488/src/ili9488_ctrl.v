...
localparam [8:0]  LCD_WM1      = 9'd319;
localparam [8:0]  LCD_HM1      = 9'd479;
...
localparam [8:0] ROW_STEP = 9'd44;
localparam [8:0] TITLE_Y  = 9'd20;
localparam [8:0] LIST_Y0  = 9'd56;
localparam [8:0] LABEL_X  = 9'd20;
localparam [8:0] VALUE_X  = 9'd190;
localparam [8:0] UNIT_X   = 9'd250;
...
function [7:0] unit_char;
    ...
    begin
        ...
        case (row)
            ...
            3'd3,3'd4,3'd5,3'd6,3'd7: begin
                case(idx)
                    3'd0: unit_char = "P";
                    3'd1: unit_char = "P";
                    3'd2: unit_char = "M";
    ...
    if (!sys_rst_n) begin
        ...
        if (delay_cnt != 0) delay_cnt <= delay_cnt - 1'b1;
            ...
            case (state)
                ...
                ST_MADCTL: begin drv_type<=CMD_PARAM; drv_cmd<=8'h36; drv_param<=8'h48; drv_en<=1'b1; delay_cnt<=TX_GAP_CYC; next_state<=ST_NORON; state<=ST_DELAY; end
                ...
                ST_RAMWR: begin
                    ...
                    v_co2<=co2;
                    v_voc<=voc;
                    pix_left<=18'd153600; pix_x<=9'd0; pix_y<=9'd0;
