...
ao_top_0  u_la0_top(
    ...
    .trig2_i(tx_set),
    .trig3_i(rx_done),
    .trig4_i({\u_uart_rx/bit_cnt[3] ,\u_uart_rx/bit_cnt[2] ,\u_uart_rx/bit_cnt[1] ,\u_uart_rx/bit_cnt[0] }),
    .trig5_i({\u_uart_rx/sample_cnt[3] ,\u_uart_rx/sample_cnt[2] ,\u_uart_rx/sample_cnt[1] ,\u_uart_rx/sample_cnt[0] }),
    .data_i({\rx_data[7] ,\rx_data[6] ,\rx_data[5] ,\rx_data[4] ,\rx_data[3] ,\rx_data[2] ,\rx_data[1] ,\rx_data[0] ,\rd_data[7] ,\rd_data[6] ,\rd_data[5] ,\rd_data[4] ,\rd_data[3] ,\rd_data[2] ,\rd_data[1] ,\rd_data[0] ,rx_done,rx_err,full,empty,wr_en,tx_set,rd_en,tx_done,\u_uart_rx/bit_cnt[3] ,\u_uart_rx/bit_cnt[2] ,\u_uart_rx/bit_cnt[1] ,\u_uart_rx/bit_cnt[0] ,\u_uart_rx/sample_cnt[3] ,\u_uart_rx/sample_cnt[2] ,\u_uart_rx/sample_cnt[1] ,\u_uart_rx/sample_cnt[0] ,rx}),
    .clk_i(sys_clk)
);
