...
ao_top_0  u_la0_top(
    ...
    .trig2_i(tx_set),
    .trig3_i(rx_err),
    .trig4_i({\u_uart_rx/rx_state[3] ,\u_uart_rx/rx_state[2] ,\u_uart_rx/rx_state[1] ,\u_uart_rx/rx_state[0] }),
    .trig5_i({\u_uart_rx/bit_cnt[3] ,\u_uart_rx/bit_cnt[2] ,\u_uart_rx/bit_cnt[1] ,\u_uart_rx/bit_cnt[0] }),
    .data_i({tx_done,rx_done,tx_set,rx_err,\tx_data[7] ,\tx_data[6] ,\tx_data[5] ,\tx_data[4] ,\tx_data[3] ,\tx_data[2] ,\tx_data[1] ,\tx_data[0] ,\rx_data[7] ,\rx_data[6] ,\rx_data[5] ,\rx_data[4] ,\rx_data[3] ,\rx_data[2] ,\rx_data[1] ,\rx_data[0] ,\u_uart_rx/rx_state[3] ,\u_uart_rx/rx_state[2] ,\u_uart_rx/rx_state[1] ,\u_uart_rx/rx_state[0] ,\u_uart_rx/bit_cnt[3] ,\u_uart_rx/bit_cnt[2] ,\u_uart_rx/bit_cnt[1] ,\u_uart_rx/bit_cnt[0] ,rx,\u_uart_rx/sample_cnt[3] ,\u_uart_rx/sample_cnt[2] ,\u_uart_rx/sample_cnt[1] ,\u_uart_rx/sample_cnt[0] ,\u_uart_rx/rx_data_buf[7] ,\u_uart_rx/rx_data_buf[6] ,\u_uart_rx/rx_data_buf[5] ,\u_uart_rx/rx_data_buf[4] ,\u_uart_rx/rx_data_buf[3] ,\u_uart_rx/rx_data_buf[2] ,\u_uart_rx/rx_data_buf[1] ,\u_uart_rx/rx_data_buf[0] ,tx_set_buf}),
    .clk_i(sys_clk)
);
